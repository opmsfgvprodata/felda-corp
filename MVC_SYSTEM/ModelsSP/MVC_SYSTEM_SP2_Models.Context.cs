...
namespace MVC_SYSTEM.ModelsSP
{
    ...
    public partial class MVC_SYSTEM_SP2_Models : DbContext
    {
        ...
        public virtual IEnumerable<sp_RptMasterDataPkj_Result> sp_RptMasterDataPkj(Nullable<int> negaraID, Nullable<int> syarikatID, Nullable<int> wilayahID, Nullable<int> ladangID, string kdrytan, string statusAktif, string kategoriPkj, string pembekalList, string jantinaList, Nullable<int> userID, string compCode)
        {
            var negaraIDParameter = negaraID.HasValue ?
                new ObjectParameter("NegaraID", negaraID) :
                new ObjectParameter("NegaraID", typeof(int));
        ...
        public virtual IEnumerable<sp_RptKatPekTem_Result> sp_RptKatPekTem(Nullable<int> negaraID, Nullable<int> syarikatID, Nullable<int> wilayahID, Nullable<int> ladangID, Nullable<int> userID, string compCode)
        {
            var negaraIDParameter = negaraID.HasValue ?
                new ObjectParameter("NegaraID", negaraID) :
                new ObjectParameter("NegaraID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_RptKatPekTem_Result>("sp_RptKatPekTem", negaraIDParameter, syarikatIDParameter, wilayahIDParameter, ladangIDParameter, userIDParameter, compCodeParameter);
        }
    }
}
