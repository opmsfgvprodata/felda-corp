...
namespace MVC_SYSTEM.Controllers
{
    ...
    public class ReportController : Controller
    {
        ...
        [AccessDeniedAuthorizeAttribute(Roles = "Super Power Admin,Super Admin,Admin 1,Admin 2,Admin 3, Super Power User, Viewer")]
        public ActionResult PecahanBangsa()
        {
            int[] wlyhid = new int[] { };
            int? NegaraID = 0;
            int? SyarikatID = 0;
            ...
            List<sp_PecahanBangsa_Result> resultreport = new List<sp_PecahanBangsa_Result>();

            return View("PecahanBangsa", resultreport);
        }
        ...
        public ActionResult PecahanBangsa(int? YearList, int WilayahIDList, int LadangIDList, string SyarikatList)
        {
            int[] wlyhid = new int[] { };
            int? NegaraID = 0;
            int? SyarikatID = 0;
            ...
            try
            {
                ...
                try
                {
                    ...
                    parameters.Add("CompCode", SyarikatList);
                    con.Open();
                    resultreport = SqlMapper.Query<sp_PecahanBangsa_Result>(con, "sp_RptPecahanBangsa", parameters, commandType: CommandType.StoredProcedure).ToList();
            ...
            ViewBag.WilayahIDList = WilayahIDList2;
            ViewBag.LadangIDList = LadangIDList2;
            ViewBag.WilayahIDList2 = WilayahIDList;
            ViewBag.LadangIDList2 = LadangIDList;
            ViewBag.SyarikatList = SyarikatList2;
            ViewBag.LadangID = LadangIDList;
            ViewBag.ladangvalue = LadangID;
            ViewBag.UserID = getuserid;
