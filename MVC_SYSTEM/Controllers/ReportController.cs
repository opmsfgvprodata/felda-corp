                ...
                else
                {
                    if (WilayahList == 0)
                    {
                        ...
                        if (LadangList == 0)
                        {
                            ...
                            //List<sp_MapaReport_Result> maybankrcmsOthersList = new List<sp_MapaReport_Result>();
                            ...
                            //parameters.Add("WilayahID", MonthList);
                            //parameters.Add("LadangID", YearList);
                            //parameters.Add("Year", CompCodeList);
                            //parameters.Add("Month", MonthList);
                            //parameters.Add("UserID", getuserid);
                            //parameters.Add("CompCode", CompCodeList);

                            //con.Open();
                            //MapaData = SqlMapper.Query<sp_MapaReport_Result>(con, "sp_MapaReport", parameters).ToList();
                            //con.Close();
